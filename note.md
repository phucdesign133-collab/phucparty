...
$i = 1; Get-ChildItem -Filter *.jpg | ForEach-Object { $newName = "khaitruong-banggia-$i.webp"; Write-Host "Đang chuyển đổi: $($_.Name) -> $newName"; magick $_.FullName -resize 1200x -quality 75 $newName; $i++ }
